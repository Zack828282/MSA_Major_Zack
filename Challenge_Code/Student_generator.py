...
def load_students(): 
     ...
     for line_of_data in (student_thing):
          ...
          try:
               if len(info) != 6:
                    write_to_error_log("ERROR SOMEWHERE IN DATA RELATED TO THE LENGTH OF A LIST")
                    co_data_num += 0
          ...
          try:
                 ...
                 write_to_error_log("ERROR SOMEWHERE IN DATA RELATED TO IMPROPER VALUES FOR CREDIT HOURS AND/OR GPA")
